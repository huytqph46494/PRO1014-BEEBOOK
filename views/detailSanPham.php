                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    ...
                                    <div class="availability">
                                        ...
                                        <span><?= 'Còn lại ' . $sanPham['so_luong'] . ' sản phẩm trong kho'?></span>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="product-review-info">
                                    <ul class="nav review-tab">
                                        <li>
                                            <a class="active" data-bs-toggle="tab" href="#tab_three">Bình
                                                luận (<?= $countComment ?>)</a>
                                        </li>
                                    </ul>
                                ...
                                <div class=" product-item">
                                    ...
                                    <div class="product-caption text-center">
                                        ...
                                        <div class="price-box">
                                            ...
                                            <span
                                                class="price-old"><?= formatPrice($sanPham['gia_san_pham']) . 'đ' ?></span>
