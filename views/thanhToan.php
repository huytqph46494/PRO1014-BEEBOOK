                                ...
                                <div class="billing-form-wrap">
                                    ...
                                    <div class="single-input-item">
                                        ...
                                        <textarea name="ghi_chu" id="ghi_chu" cols="30" rows="3"
                                            placeholder="Nhập ghi chú đơn hàng của bạn..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Tổng đơn hàng</td>
                                                    <td><strong><?= formatPrice($tongGioHang + 30000) . 'đ' ?></strong>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        ...
                                        <div class="single-payment-method show">
                                            <div class="payment-method-name">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="cashon" name="phuong_thuc_thanh_toan_id"
                                                        value="1" class="custom-control-input" checked />
                                                    <label class="custom-control-label" for="cashon">Thanh
                                                        toán khi nhận
                                                        hàng</label>
                                                </div>
                                            </div>
                                            <div class="payment-method-details" data-method="cash">
                                                <p>Khách hàng có thể thanh toán sau khi đã nhận hàng thành
                                                    công (cần xác
                                                    nhận đơn hàng).</p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="payment-method-name">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="directbank">Thanh toán bằng
                                                        phương thức chuyển khoản</label>
                                                </div>
                                            </div>
                                            <div class="payment-method-details" data-method="bank">
                                                <p>Khách hàng cần chuyển khoản.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="summary-footer-area">
                                            <div class="custom-control custom-checkbox mb-20">
                                                <input type="checkbox" class="custom-control-input" id="terms"
                                                    required />
                                                <label class="custom-control-label" for="terms">Xác nhận đặt
                                                    hàng</label>
                                            </div>
                                            <button type="submit" class="btn btn-sqr">Tiến hành đặt
                                                hàng</button>
                                        </div>
                                    </div>
