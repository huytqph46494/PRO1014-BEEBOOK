                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        ...
                        <div class="widget-body">
                            <p>Chúng tôi là một cửa hàng sách trực tuyến, mang đến cho bạn những cuốn sách hay, đa dạng
                                thể loại, chất lượng in ấn tốt với mức giá hợp lý. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                        ...
                        <div class="widget-body">
                            <address class="contact-block">
                                <ul>
                                    ...
                                    <li><i class="pe-7s-mail"></i> <a href="#">admin@gmail.com </a></li>
                                    <li><i class="pe-7s-call"></i> <a href="#">0123-456-789</a></li>
                                </ul>
                            </address>
                        </div>
                    </div>
