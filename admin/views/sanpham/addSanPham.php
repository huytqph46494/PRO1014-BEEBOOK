    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= BASE_ADMIN_URL . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data">
                <div class="row card-body">
                 ...
                 <div class="form-group col-6">
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-control" name="danh_muc_id" id="exampleFormControlSelect1" required>
