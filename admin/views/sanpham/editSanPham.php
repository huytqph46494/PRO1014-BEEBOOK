        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <form action="<?= BASE_ADMIN_URL . '?act=sua-san-pham'?>" method="post"
            ...
            <div class="col-md-4">
                <div class="card card-info">
                    ...
                    <form action="<?= BASE_ADMIN_URL . '?act=sua-album-anh-san-pham'?>" method="post"
                        enctype="multipart/form-data">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class="text-center">
                                                    <button onclick="addfaqs();" type="button"
...
function addfaqs() {
    ...
    html +=
        '<td><img src="https://png.pngtree.com/element_our/20200702/ourmid/pngtree-white-flip-notebook-picture-book-image_2286277.jpg" style="width:50px; height:50px;" alt=""/></td>';
...
function removeRow(row_Id, img_Id) {
    $('#faqs-row-' + row_Id).remove();
    if (img_Id !== null) {
        let imgDeleteInput = document.getElementById('img_delete');
        let currentValue = imgDeleteInput.value;
        imgDeleteInput.value = currentValue ? currentValue + ',' + img_Id : img_Id;
    }
}
</script>
</body>
