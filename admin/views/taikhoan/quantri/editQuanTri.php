            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= BASE_ADMIN_URL . '?act=sua-quan-tri' ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" name="trang_thai" class="form-control custom-select">
                                        <option <?= $quanTri['trang_thai'] == 1 ? 'selected' : '' ?> value="1">Hoạt động
                                        </option>
                                        <option <?= $quanTri['trang_thai'] !== 2 ? 'selected' : '' ?> value="2">Ngừng
                                            Hoạt Động
                                        </option>
                                    </select>
                                </div>
