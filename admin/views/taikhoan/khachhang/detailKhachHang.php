                        ...
                        <table class="table table-borderless">
                            <tbody style="font-size: large;">
                                ...
                                <tr>
                                    <th>Ngày sinh:</th>
                                    <td>
                                        <?= isset($khachHang['ngay_sinh']) && $khachHang['ngay_sinh'] !== '0000-00-00' 
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="badge text-bg-<?= $donHang['ten_trang_thai']?>"><?= $donHang['ten_trang_thai']?></span>
                                    </td>
                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_bank"
                                        href="<?= BASE_ADMIN_URL. '?act=chi-tiet-san-pham&id_san_pham=' . $binhLuan['san_pham_id'];?>"><?=$binhLuan['ten_san_pham']?>
                                    </a>
                                </td>
                                ...
                                <td>
                                    <form action="<?= BASE_ADMIN_URL . '?act=update-trang-thai-binh-luan'?>"
                                        ...
                                        <button type="submit" onclick="return confirm('Bạn có muốn ẩn bình luận không')"
